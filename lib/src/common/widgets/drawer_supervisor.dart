                              ...
                              onTap: () async {
                                ...
                                switch (titleArray[i]) {
                                  ...
                                  case "My Visits":
                                    {
                                      Get.back();
                                      // Get.toNamed(Routes.UpcomingVisits_S);
                                    }
                                    break;
                                  case "My Profile":
                                    {
                                  ...
                                  case "Rejected Task":
                                    {
                                      Get.back();
                                      // Get.toNamed(Routes.RejectedTask_S);
                                    }
                                    break;
                                  case "Rejected Orders":
                                    {
                                      Get.back();
                                      // Get.toNamed(Routes.RejectedOrders_S);
                                    }
                                    break;
                                  case "QC Completed":
                                    {
                                      Get.back();
                                      // Get.toNamed(Routes.qc_completed_list_S);
                                    }
                                    break;
                                  default:
                                    {
